	...
	<div class="main-inner flex fl-1 fl-row ">
				...
				<ul>
					...
					<ul>
						<li id="active" class="active">
							<a href="<?php echo BASE_URL;?>admin/blogID/<?php echo $blog->blogID;?>/dashboard/pages">All<?php $dashObj->getPostsCount('Page', '', $blog->blogID);?></a>
						</li>
						<li>
							<a href="?type=draft" id="draft">Draft<?php $dashObj->getPostsCount('Page', 'draft', $blog->blogID);?></a>
						</li>
						<li>
							<a href="?type=published" id="published">Published<?php $dashObj->getPostsCount('Page', 'published', $blog->blogID);?></a>
						</li>
					</ul> 
					...
					<li><span><i class="fas fa-pager"></i></span>
						<a href="<?php echo BASE_URL;?>admin/blogID/<?php echo $blog->blogID;?>/template/edit">Theme</a>
					</li>
		...
		<div class="main-right-inner flex fl-c">
			...
			<div id="posts" class="main-right-content fl-4">
 			...
 			<script type="text/javascript" src="<?php echo BASE_URL;?>frontend/assets/js/pagePagination.js"></script>
