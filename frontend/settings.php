							...
							<tr>
								...
								<td class="td-des">
									...
									<div class="bn-title" id="titleBlock">
										<div class="bn-input">
											<input type="text" name="title" value="<?php echo $blog->Title;?>" id="titleInput">
							...
							<tr>
								...
								<td class="td-des">
									...
									<div class="bn-title" id="descBlock">
										<div class="bn-input">
											<textarea class="text-area" id="descInput"><?php echo $blog->Description;?></textarea>
								...
								<td class="td-des">
									...
									<div class="au-main">
										...
										<div class="bn-input ad-auth">
											...
											<div>
												<input type="password" name="passwordRe" id="passReInput">
											</div>
											<div class="bt-error" id="passReError"> 	
											</div>
										</div>
										</div>
										<div class="au-right">
							...
							<tr>
								...
								<td class="td-des">
									...
									<div class="bn-title" id="metaDescBlock">
										<div class="bn-input">
											<textarea class="text-area" id="metaDescInput"><?php echo $blog->MetaDescription;?></textarea>
							  ...
							  <td class="td-title">
								...
								<td class="td-des">
									...
									<div class="bn-title" id="customBlock">
										<div class="bn-input">
										 <textarea class="text-area" id="customInput"><?php echo $blog->CustomError;?></textarea>
						...
						<tbody>
							<tr>
								...
								<td class="td-des">
									...
									<div class="bn-title, display">
										<div class="bn-input">
											<input type="text" name="email" id="editEmail" value="<?php echo $blog->email;?>">
							...
							<tr>
								...
								<td class="td-des">
									...
									<div class="bn-title, display">
										<div class="bn-input">
											<input type="text" name="displayName" id="editDisplayName" value="<?php echo $blog->fullName;?>"> 
					...
					<table>
						<tbody>
							...
							<tr>
								...
								<td>
									<div class="bn-button">
										<button class="btn-newp" id="savePassBtn" data-blog="<?php echo $blog->blogID;?>">Save changes</button>
									</div>
								</td>
							</tr>
						</tbody>
