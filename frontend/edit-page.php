...
<html>
<head>
	<title>Edit Page - Admin Panel - MyBlogger</title>
...
<div class="inner-wrapper flex fl-c">
	...
	<div class="edit-wrap-inner flex fl-c">
							...
							<div class="edm-label-box">
								...
								<div class="edm-label-show">
									<div>
										...
										<div class="short-div" id="slugDiv"><?php echo "http://www.{$blog->Domain}.localhost/MyBlogger/{$post->slug}";?>
										</div>
									</div>
								</div>	
							...
							<div class="edm-label-box">
								...
								<div class="edm-label-body">
									<div class="edm-label-textarea">
										<textarea rows="4" id="description"><?php echo $post->description;?>
										</textarea>
									</div>
									<div class="edm-label-button">
 									</div>
		...
		<!-- JS Files -->
		<script type="text/javascript" src="<?php echo BASE_URL;?>frontend/assets/js/editPage.js"></script>
	</div>
	<!--EDIT-INNER-ENDS-->	
	</div>
	<!--EDIT-WRAP-ENDS-->
