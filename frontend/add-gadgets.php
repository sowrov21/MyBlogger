			...
			<?php else:?>
				...
				<div class="l-popup-body">
					<div class="lp-box flex fl-row">
						...
						<div class="lpopup-add">
							...
							<?php else: ?>
							<span>
								<a href="javascript:;" id="addGadget" data-type="topPosts" data-blog="<?php echo $blogID;?>" data-area="<?php echo $area;?>" data-pos="<?php echo $pos;?>">
				...
				<div class="l-popup-body">
					<div class="lp-box flex fl-row">
						...
						<div class="lpopup-add">
							...
							<?php else: ?>
							<span>
								<a href="javascript:;" id="addGadget" data-type="search" data-blog="<?php echo $blogID;?>" data-area="<?php echo $area;?>" data-pos="<?php echo $pos;?>">
									<i class="fas fa-plus-square"></i>
								</a>
							</span>
							<?php endif; ?>
				...
				<div class="l-popup-body">
					<div class="lp-box flex fl-row">
						...
						<div class="lpopup-add">
							<span>
								<a href="javascript:;" id="addGadget" data-type="html" data-blog="<?php echo $blogID;?>" data-area="<?php echo $area;?>" data-pos="<?php echo $pos;?>">
									<i class="fas fa-plus-square"></i>
								</a>
							</span>
						</div>		
				...
				<div class="l-popup-body">
					<div class="lp-box flex fl-row">
						...
						<div class="lpopup-add">
							<span>
								<a href="javascript:;" id="addGadget" data-type="profile" data-blog="<?php echo $blogID;?>" data-area="<?php echo $area;?>" data-pos="<?php echo $pos;?>">
									<i class="fas fa-plus-square"></i>
								</a>
							</span>
						</div>		
				...
				<div class="l-popup-body">
					<div class="lp-box flex fl-row">
						...
						<div class="lpopup-add">
							<span>
								<a href="javascript:;" id="addGadget" data-type="labels" data-blog="<?php echo $blogID;?>" data-area="<?php echo $area;?>" data-pos="<?php echo $pos;?>">
									<i class="fas fa-plus-square"></i>
								</a>
							</span>
						</div>		
				...
				<div class="l-popup-body">
					<div class="lp-box flex fl-row">
						...
						<div class="lpopup-add">
							<span>
								<a href="javascript:;" id="addGadget" data-type="list" data-blog="<?php echo $blogID;?>" data-area="<?php echo $area;?>" data-pos="<?php echo $pos;?>">
									<i class="fas fa-plus-square"></i>
								</a>
							</span>
						</div>		
